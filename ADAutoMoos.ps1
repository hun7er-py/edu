...
try{
    ...
    New-ADOrganizationalUnit -Name "Logistiek" -Path "OU=moos, DC=moos, DC=local"
    New-ADOrganizationalUnit -Name "Marketing" -Path "OU=moos, DC=moos, DC=local"
    New-ADOrganizationalUnit -Name "Transport" -Path "OU=moos, DC=moos, DC=local"
    New-ADOrganizationalUnit -Name "Extern" -Path "OU=moos, DC=moos, DC=local"
}
catch{
